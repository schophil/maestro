...
<title><?php $document = $context->getPara('document');?><?php if (isset($document)) {echo $document->getName();}?></title>
</head>
<body>
...
<div class="content"><?php $activiteit = $context->getPara('activiteit');?><?php if (isset($activiteit) and ($activiteit != null)) {?><div id="agendaNext" class="message">
<p>Volgende activiteit:</p>
<p class="agendaTitle"><?php if (isset($activiteit)) {echo $activiteit->getTitle();}?></p>
<p class="agendaTime"><?php if (isset($activiteit)) {echo $activiteit->getFromDate();}?></p>
<p style="font-size: 10px;">Raadpleeg onze volledige <a href="index.php?action=wcm&amp;name=agenda">agenda</a>.</p>
</div><?php }?><?php $document = $context->getPara('document');?><?php if (isset($document)) {echo $document->getContent();}?></div>
<div class="footer">
